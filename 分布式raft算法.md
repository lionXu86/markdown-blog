...
分布式的入门算法，搞懂了raft算法，基本对服务的分布式协作有了一个比较全面的认识和理解，甚至可以自己去实现基本的框架。raft算法自己研究过很久，里面的算法也基本理解，只是自己并没有去实现一套代码，比较懒，也觉得没必要重复造轮子。像zookeeper.consul,etcd，这样的框架都很好的实现了这套算法，是系统架构设计的核心基础。
